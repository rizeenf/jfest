    ...
    hooks: {
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdProd, updated, data, updatedProd, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            createdProd = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: createdProd.id, priceId: createdProd.default_price });
                        ...
                        case 3:
                            updatedProd = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: updatedProd.id, priceId: updatedProd.default_price });
                            return [2 /*return*/, updated];
