...
var query_validator_product_1 = require("../lib/validators/query-validator-product");
...
exports.appRouter = (0, trpc_1.router)({
    ...
    getAllProducts: trpc_1.publicProcedure
        .input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
        cursor: zod_1.z.number().nullish(),
        query: query_validator_product_1.QueryValidate,
    }))
        .query(function (_a) {
        var input = _a.input;
