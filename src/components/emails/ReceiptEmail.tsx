...
export const ReceiptEmail = ({
  ...
  orderId,
  products,
}: ReceiptEmailHTMLProps) => {
  const total = products.reduce((acc, curr) => acc + curr.price, 0) + 9999;

  return (
    <Html>
      <Head />
      <Preview>Your MyJFest Receipt</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
            ...
            <Column style={productPriceWrapper} align="right">
              <Text style={productPrice}>{formatPrice(9999)}</Text>
            </Column>
          </Section>
...
export const ReceiptEmailHTML = (props: ReceiptEmailHTMLProps) =>
